...
module Bindings_utils = struct
  ...
  (** Inject something as a JS object, be sure its Js.t already, functions
      seemingly exempt *)
  ...
  (** Call a function for each value of each key in an Object, throw away result *)
  let for_each_iter ~f obj =
    keys obj |> List.iter (fun k -> f (Js.Unsafe.get obj k))

  (** Call a function for each value of each key in an Object, keep result *)
...
let __filename () : Js.js_string Js.t = Js.Unsafe.eval_string "__filename"

let __dirname () : Js.js_string Js.t = Js.Unsafe.eval_string "__dirname"

module Events = struct
  class type event_emitter =
    object ('self)
  ...
  class type socket =
    object
      ...
      method connect :
        ...
        ; family : int Js.prop
        ; hints : int Js.prop
        ; lookup : 'a Js.callback Js.opt Js.t Js.prop >
        Js.t
  ...
  and net =
    object
      ...
      method createServer_withOptionsAndConnListener :
           ...
           ; pauseOnConnect : bool Js.t Js.prop >
           Js.t
        -> server Js.t Js.meth
    end
    ...
    object
      method readFileSync :
        ...
        -> < encoding : Js.js_string Js.t Js.Opt.t Js.readonly_prop
           ; flag : Js.js_string Js.t Js.readonly_prop >
           Js.t
...
module Http = struct
  ...
  let agent_with_options :
    (   < keepAlive : bool Js.t Js.readonly_prop
        ...
        ; maxFreeSockets : int Js.readonly_prop >
        Js.t
     -> agent Js.t )
    Js.constr =
