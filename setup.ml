...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6c97ed1817547614871fe6deea0c0adb) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/fxfactorial/ocaml-nodejs";
          synopsis = "js_of_ocaml bindings for nodejs";
          description =
            Some
              [
                 OASISText.Para
                   "Write OCaml, run on node These are js_of_ocaml bindings to the node JavaScript API. Get all the power of the node ecosystem with the type safety of OCaml."
              ];
          categories = [];
            ...
            [
               ...
               Library
                 ({
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("lwt",
                               Some (OASISVersion.VGreaterEqual "2.5.1"));
                           InternalLibrary "nodejs";
                           InternalLibrary "pervasives_js";
                           FindlibPackage ("yojson", None);
                           FindlibPackage ("magic-mime", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                   ...
                   {
                      lib_modules = ["Nodejs_Events"; "Nodejs_Main"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "nodejs";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "o‚at\t|≈€l\144\020l\156\018ËT";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
